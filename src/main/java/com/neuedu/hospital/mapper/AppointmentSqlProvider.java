...
import com.neuedu.hospital.pojo.AppointmentExample.Criteria;
import com.neuedu.hospital.pojo.AppointmentExample.Criterion;
...
public class AppointmentSqlProvider {
    ...
    public String insertSelective(Appointment record) {
        ...
        if (record.getIlness() != null) {
            VALUES("ilness", "#{ilness,jdbcType=VARCHAR}");
        }
        
        if (record.getBooktime() != null) {
            VALUES("booktime", "#{booktime,jdbcType=DATE}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIlness() != null) {
            SET("ilness = #{record.ilness,jdbcType=VARCHAR}");
        }
        
        if (record.getBooktime() != null) {
            SET("booktime = #{record.booktime,jdbcType=DATE}");
        }
    ...
    public String updateByPrimaryKeySelective(Appointment record) {
        ...
        if (record.getIlness() != null) {
            SET("ilness = #{ilness,jdbcType=VARCHAR}");
        }
        
        if (record.getBooktime() != null) {
            SET("booktime = #{booktime,jdbcType=DATE}");
        }
