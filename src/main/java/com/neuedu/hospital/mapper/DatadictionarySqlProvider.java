...
import com.neuedu.hospital.pojo.DatadictionaryExample.Criteria;
import com.neuedu.hospital.pojo.DatadictionaryExample.Criterion;
...
public class DatadictionarySqlProvider {
    ...
    public String insertSelective(Datadictionary record) {
        BEGIN();
        INSERT_INTO("datadictionary");
        
        if (record.getDatadictionaryId() != null) {
            VALUES("datadictionary_id", "#{datadictionaryId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(DatadictionaryExample example) {
        ...
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("datadictionary_id");
        } else {
            SELECT("datadictionary_id");
        }
        SELECT("type");
        SELECT("value");
        SELECT("name");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDatadictionaryId() != null) {
            SET("datadictionary_id = #{record.datadictionaryId,jdbcType=INTEGER}");
        }
